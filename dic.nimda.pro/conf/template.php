        ...
        <title>Словари и энциклопедии.</title>
        <meta http-equiv=Content-Type content="text/html;charset=UTF-8">
        <link id="page_favicon" href="../images/favicon.ico" rel="icon" type="image/x-icon" />
        <meta property="og:title" content="Словари и энциклопедии.">
        ...
        <meta name="description" content="NIMDA Group Ltd. — российская ИТ-компания, владеющая одноимённой системой в Сети и интернет-порталом.">
        <meta name="author"      content="John Li (https://nimda.pro)">
        <link href="../css/bootstrap.min.css" rel="stylesheet" type="text/css">
        <link rel="stylesheet" href="../css/style.css">
        <br>
        <br>
        <div class="col-md-10 col-lg-10 col-md-offset-1 col-lg-offset-1 text-center">
            <p><a href="/" class="btn btn-default btn-lg">На главную</a></p>
        </div>
        <br>
        <br>
<!-- Analytics -->

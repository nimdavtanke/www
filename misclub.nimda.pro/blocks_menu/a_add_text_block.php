...
<a href='$clear_uri?quick_edit=add_block&block_type=0&cat_id=$m_id'><img src='images/webcms/ico_add.gif' border='0' align='absmiddle'> Добавить текстовый блок</a></div></td>
</tr>
</table>";
?>